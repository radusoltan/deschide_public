...
export const SpecialArticles = () => {
  ...
  if (specialArticlesLoading) return <>LOADING ...</>
        ...
        return <div className="container max-w-7xl mx-auto mb-5" key={article_id}>
          <div className="relative rounded-lg block md:flex items-center bg-gray-100 shadow-xl h-56"
            ...
            <div
              ...
              <div className="absolute inset-0 w-full h-2/3 top-28 -left-3 flex items-center justify-center fill-current text-white">
                <Link
